...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@pirate_flicks ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            InlineKeyboardButton('💡ᴜᴩᴅᴀᴛᴇꜱ💡', url='https://t.me/cv_official_channel')
           ],[
